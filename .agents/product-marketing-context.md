# Contexto del Proyecto — Guía Dolomitas
...
## Audiencia
Viajeros hispanohablantes (España y LATAM) que planifican un viaje a los Dolomitas. Nivel: turistas con ganas de salirse de lo convencional, no montañeros expertos. Buscan información práctica, honesta y concreta.

## Tono y voz
- Experto pero cercano, como un amigo que ha estado allí
- Específico y concreto (precios reales, horarios reales, distancias reales)
- Honesto: si algo tiene inconvenientes, se dicen
- Nunca genérico ni relleno de marketing vacío

## Funnel
SEO → artículo → mid-CTA (capítulo gratis) → paywall → descarga → email → venta guía completa
